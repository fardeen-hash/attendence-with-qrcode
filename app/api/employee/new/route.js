...
export const POST = async (request) => {
    const { userId, employee_name,mobile_num,aadhar,id_card,
    ...
    try {
        ...
        const newEmployee = new Employee({ creator: userId, employee_name,time, mobile_num,aadhar,id_card,designation,res_no,full_addr,police,contactractor_addr,addr_house_owner,bank_account,other_details});
